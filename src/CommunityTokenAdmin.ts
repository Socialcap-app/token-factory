import {
  ...
  export type CommunityTokenAdminBase = SmartContract & {
  ...
  export interface CommunityTokenAdminDeployProps extends Exclude<DeployArgs, undefined> {
   ...
   */
  export class CommunityTokenAdmin extends SmartContract implements CommunityTokenAdminBase {
    @state(PublicKey)
    private adminPublicKey = State<PublicKey>()
  
    async deploy(props: CommunityTokenAdminDeployProps) {
